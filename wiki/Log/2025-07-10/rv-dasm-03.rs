...
fn main() {
    ...
    const INSTS: [u32; 12] = [
        0x00000013_u32, // 1: addi x0, x0, 0
        0x00100093_u32, // 2: addi x1, x0, 1
        0x00200113_u32, // 3: addi x2, x0, 2
        0xfff00193_u32, // 4: addi x3, x0, -1
        0x7ff00213_u32, // 5: addi x4, x0, 0x7ff
        0x00308f93_u32, // 6: addi x31, x1, 3
        0x00410413_u32, // 7: addi x8, x2, 4
        0x00820813_u32, // 8: addi x16, x4, 8
        0x01040893_u32, // 9: addi x17, x8, 16
        0xff040893_u32, // 10: addi x18, x8, -16
        0x80040893_u32, // 11: addi x17, x8, -2048
        0x0aa00093_u32  // 12: addi x1, x0, 0xAA    
    ];
